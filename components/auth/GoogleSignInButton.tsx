interface GoogleSignInButtonProps {
  ...
  const GoogleSignInButton = ({ onClick }: GoogleSignInButtonProps) => (
    <button
      type="button"
      className="w-full inline-flex items-center justify-center py-2.5 px-5 mb-2 text-sm font-medium text-gray-900 bg-white border rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:text-white"
      onClick={onClick}
    >
      <svg
